...
# data folders
data_dir="../data/Conv_denoise"
base_model=Conv
denoise_thres=0.7  # denoising threshold

# generating initial dataset
python3 gen_dataset.py --dset_path "${data_dir}/original_dset-ubyte.gz"

# running autoencoders chain
python3 make_chain.py --dset_dir "$data_dir" --model_type "$base_model" --denoise_thres "$denoise_thres"  >  "${data_dir}/report.out"
